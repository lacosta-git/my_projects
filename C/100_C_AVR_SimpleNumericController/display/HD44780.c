...
{
	// Part of code added for support 4x20 Display
	uint8_t address = 0;
	if (y == 0) address = x;
	if (y == 1) address = x + 64;
	if (y == 2) address = x + 20;
	...
	LCD_WriteCommand(HD44780_DDRAM_SET | address);
}
//-------------------------------------------------------------------------------------------------
//
...
LCD_WriteCommand(HD44780_DISPLAY_ONOFF | HD44780_DISPLAY_ON | HD44780_CURSOR_BLINK); // w≥πcz LCD, kursor


#ifdef DISPLAY_4X20
LCD_WriteCommand(HD44780_FUNCTION_SET | HD44780_RE_ENABLE | HD44780_TWO_LINE | HD44780_4_BIT); // interfejs 4-bity, enter RE
LCD_WriteCommand(HD44780_RE_EXT_FUNCTION_SET | HD44780_4_LINE_DISPLAY);
LCD_WriteCommand(HD44780_RE_FUNCTION_SET | HD44780_RE_RE_DISABLE | HD44780_RE_TWO_LINE | HD44780_RE_4_BIT);
LCD_WriteCommand(HD44780_DISPLAY_ONOFF | HD44780_DISPLAY_OFF); // wy≥πczenie wyswietlacza
LCD_WriteCommand(HD44780_CLEAR); // czyszczenie zawartosÊi pamieci DDRAM
LCD_WriteCommand(HD44780_ENTRY_MODE | HD44780_EM_SHIFT_CURSOR | HD44780_EM_INCREMENT);// inkrementaja adresu i przesuwanie kursora
LCD_WriteCommand(HD44780_DISPLAY_ONOFF | HD44780_DISPLAY_ON | HD44780_CURSOR_BLINK); // w≥πcz LCD, kursor
