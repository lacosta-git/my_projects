...
extern uint8_t ds1307_setdate_BCD(uint8_t year, uint8_t month, uint8_t day, uint8_t dayOfWeek, uint8_t hour, uint8_t minute, uint8_t second);
extern void ds1307_getdate(uint8_t *year, uint8_t *month, uint8_t *day, uint8_t *hour, uint8_t *minute, uint8_t *second);
extern void ds1307_getdate_BCD(uint8_t *year, uint8_t *month, uint8_t *day, uint8_t *hour, uint8_t *minute, uint8_t *second);
extern void ds1307_write_RAM_B(uint8_t data, uint8_t address);
extern void ds1307_write_RAM_W(uint16_t data, uint8_t address);
extern uint8_t ds1307_read_RAM_B(uint8_t address);
extern uint16_t ds1307_read_RAM_W(uint8_t address);
