...
//   OUTPUTS
#define MEM_CS_LOW			PORTB &=~(1<<PB2)
#define MEM_CS_HIGH			PORTB |=(1<<PB2)
#define MEM_CS_TOGLE		PORTB ^=(1<<PB2)
#define MEM_CS_AS_OUTPUT	PB2_OUT

#define SPI_SCK_LOW			PORTB &=~(1<<PB5)
#define SPI_SCK_HIGH		PORTB |=(1<<PB5)
#define SPI_SCK_TOGLE		PORTB ^=(1<<PB5)
#define SPI_SCK_AS_OUTPUT	PB5_OUT

#define SPI_MOSI_LOW		PORTB &=~(1<<PB3)
#define SPI_MOSI_HIGH		PORTB |=(1<<PB3)
#define SPI_MOSI_TOGLE		PORTB ^=(1<<PB3)
#define SPI_MOSI_AS_OUTPUT	PB3_OUT

#define SPI_MISO_LOW		PORTB &=~(1<<PB4)
#define SPI_MISO_HIGH		PORTB |=(1<<PB4)
#define SPI_MISO_TOGLE		PORTB ^=(1<<PB4)
#define SPI_MISO_AS_INPUT	PB4_IN

#define YELLOW_LED_ON		PORTD &=~(1<<PD7)
#define YELLOW_LED_OFF		PORTD |=(1<<PD7)
#define YELLOW_LED_TOGLE	PORTD ^=(1<<PD7)
#define YELLOW_LED_PIN_AS_OUTPUT	PD7_OUT

#define RED_LED_ON		PORTD &=~(1<<PD4)
#define RED_LED_OFF		PORTD |=(1<<PD4)
#define RED_LED_TOGLE	PORTD ^=(1<<PD4)
#define RED_LED_PIN_AS_OUTPUT	PD4_OUT
