...
volatile uint8_t rs_dara_receive_complete; // USART Data Receive Complete flag
...
uint8_t rs_read_received_data(char* rs_rx_data){
	*rs_rx_data = *rs_data_register;
	return 0;
}
