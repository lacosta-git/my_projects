...
#define LCD_RS_PIN		PINK
#define LCD_RS			(1 << PK0)

#define LCD_RW_DIR		DDRK
#define LCD_RW_PORT		PORTK
#define LCD_RW_PIN		PINK
#define LCD_RW			(1 << PK1)

#define LCD_E_DIR		DDRK
#define LCD_E_PORT		PORTK
#define LCD_E_PIN		PINK
#define LCD_E			(1 << PK2)

#define LCD_DB4_DIR		DDRK
#define LCD_DB4_PORT	PORTK
#define LCD_DB4_PIN		PINK
#define LCD_DB4			(1 << PK4)

#define LCD_DB5_DIR		DDRK
#define LCD_DB5_PORT	PORTK
#define LCD_DB5_PIN		PINK
#define LCD_DB5			(1 << PK5)

#define LCD_DB6_DIR		DDRK
#define LCD_DB6_PORT	PORTK
#define LCD_DB6_PIN		PINK
#define LCD_DB6			(1 << PK6)

#define LCD_DB7_DIR		DDRK
#define LCD_DB7_PORT	PORTK
#define LCD_DB7_PIN		PINK
#define LCD_DB7			(1 << PK7)
