...
//   OUTPUTS
#define RED_LED_OFF		PORTB &=~(1<<PB1)
#define RED_LED_ON		PORTB |=(1<<PB1)
#define RED_LED_TOGLE	PORTB ^=(1<<PB1)

#define HEATER_1_OFF	PORTC &=~(1<<PC1)
#define HEATER_1_ON		PORTC |=(1<<PC1)
#define HEATER_1_TOGLE	PORTC ^=(1<<PC1)

#define HEATER_2_OFF	PORTC &=~(1<<PC2)
#define HEATER_2_ON		PORTC |=(1<<PC2)
#define HEATER_2_TOGLE	PORTC ^=(1<<PC2)

#define HEATER_3_OFF	PORTC &=~(1<<PC3)
#define HEATER_3_ON		PORTC |=(1<<PC3)
#define HEATER_3_TOGLE	PORTC ^=(1<<PC3)

#define HEATER_4_OFF	PORTC &=~(1<<PC4)
#define HEATER_4_ON		PORTC |=(1<<PC4)
#define HEATER_4_TOGLE	PORTC ^=(1<<PC4)

#define BUTTON_LED_OFF		PORTD &=~(1<<PD5)
#define BUTTON_LED_ON		PORTD |=(1<<PD5)
#define BUTTON_LED_TOGLE	PORTD ^=(1<<PD5)
